            ...
            switch (user_choice)
            {
                case 1:
                    ...
                    } else
                    {
                        ...
                        int quant = s.nextInt();
                        Book book = myBkStore.Book(bt, pages, price, quant);
...
// of the Bank calling object.
    ...
    for (i = 0; i < totalbooks; i++)
    {
        ...
        public Book Book(String title, int pages, double price, int quantity)
        {
            Book book = new Book(title, pages, price, quantity);
